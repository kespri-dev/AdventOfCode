...
typealias Direction = (axe: Axes, value: Int)
...
extension Array where Element == Direction {
    func coordinates() -> [(Int, Int)] {
        ...
        return self.reduce(into: [(Int, Int)]()) {
            ...
            // TODO enumrate each value between x and value
            if $1.axe == .x {
                x += $1.value
            } else {
                y += $1.value
